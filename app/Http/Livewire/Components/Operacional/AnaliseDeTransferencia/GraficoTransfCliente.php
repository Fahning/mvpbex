...
class GraficoTransfCliente extends Component
{
    public $dataGraf;
    ...
    public function formatData($data)
    {
        ...
        foreach ($data as $value){
            $value = (array)$value;
            array_push($dataGraf['nome_pagador'], $value['nome_pagador']);
    ...
    {
        return view('livewire.components.operacional.analise-de-transferencia.grafico-transf-cliente');
    }
}
