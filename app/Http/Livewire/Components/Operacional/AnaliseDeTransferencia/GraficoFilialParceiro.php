...
class GraficoFilialParceiro extends Component
{
    ...
    public function mount()
    {
        ...
        $this->dataGraf = DB::table('bexsal_reports.base_custos_transf', 'mf')
            ...
            ->leftJoin('bexsal_bdsal.relacao_unidade_geral as bs', 'mf.und_origem', '=', 'bs.sigla')
    ...
    {
        return view('livewire.components.operacional.analise-de-transferencia.grafico-filial-parceiro');
    }
}
