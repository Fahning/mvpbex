...
class GraficoColetaBase extends Component
{
    public $dataGraf;
    ...
    public function formatData($data)
    {
        ...
        foreach ($data as $value){
            $value = (array)$value;
            array_push($dataGraf['unidade'], $value['unidade']);
    ...
    public function filtrar($filtros)
    {
        ...
        $this->dataGraf = DB::table('bexsal_reports.report_076', 'cb')
            ...
            ->where(DB::raw("IF((con.data_emissao IS NOT NULL), YEAR(con.data_emissao), YEAR(cb.data_baixa))"), $filtros['ano'])
    ...
    {
        return view('livewire.components.operacional.analise-de-entregas.grafico-coleta-base');
    }
}
