...
class GraficoColetaRota extends Component
{
    public $dataGraf;
    ...
    public function mount()
    {
        $this->dataGraf = DB::table('bexsal_reports.report_076', 'cb')
            ->select(
                DB::raw("IF(cb.set_ IS NOT NULL, cb.set_ , 'SEM ROTA') AS rota"),
    ...
    {
        return view('livewire.components.operacional.analise-de-entregas.grafico-coleta-rota');
    }
}
