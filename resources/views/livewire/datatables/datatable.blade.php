<div>
    ...
    @endif
    <div class="relative"  style="width:92vw;">
        <div class="text-center font-bold text-xl text-gray-500">{{ $title ?? 'Tabela'}}</div>
        ...
        @endif
        <div wire:loading.class="opacity-50" class="rounded-lg @unless($complex || $this->hidePagination) rounded-b-none @endunless shadow-lg bg-white max-w-full overflow-x-scroll border-4 @if($this->activeFilters) border-blue-500 @else border-transparent @endif @if($complex) rounded-b-none border-b-0 @endif">
            <div>
                <div class="table align-middle w-400">
                    ...
                    @empty
                        <p class="p-3 text-lg text-teal-600">
                            {{ __("Nenhum dado para ser exibido.") }}
                        </p>
                    @endforelse
                </div>
            </div>
