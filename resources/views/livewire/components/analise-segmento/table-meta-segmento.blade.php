<div class="bg-white shadow-md pb-4 px-4 rounded-md w-full">
    ...
    <div class="flex items-center mb-1">
        <x-select
            ...
            wire:model.defer="selectSegmentos"
        />
        <div wire:click="searchSegmentos" class="bg-green-400 rounded-lg h-9 w-9 ml-2 flex justify-center items-center cursor-pointer hover:bg-green-500">
            ...
            @foreach($table as $row)
                <tr class="hover:bg-gray-100 border-b border-gray-200 py-2">
                    @foreach($row as $key => $value)
                        ...
                        @elseif($key == 'Meta' || $key == 'Desvio (R$)' || $key == 'Média')
