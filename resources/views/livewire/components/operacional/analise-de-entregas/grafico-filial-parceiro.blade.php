<div wire:init="montaChart()">
    ...
    <div wire:loading.class="hidden" class="bg-white p-3 border shadow-md rounded-md">
        <div id="chartFilialE" style="height:280px;"></div>
    </div>

</div>

<script>
        window.addEventListener('renderDataGrafFilialParcE', ({ detail }) => {
            Highcharts.chart('chartFilialE', {
                chart: {
                    type: 'bar'
                },
                title: {
                    text: 'Custo Filial x Parceiro'
                },
                xAxis: {
