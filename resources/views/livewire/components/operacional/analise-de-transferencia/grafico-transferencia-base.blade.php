<div wire:init="montaChart()">
    ...
    <div wire:loading.class="hidden" class="bg-white p-3 border shadow-md rounded-md">
        <div id="chartBaseTransf" style="height:280px;"></div>
    </div>

</div>

<script>
    window.addEventListener('renderDataTransfBase', ({ detail }) => {
        Highcharts.chart('chartBaseTransf', {
            chart: {
                type: 'bar'
            },
            title: {
                text: 'Custo Transferência x Base'
            },
            xAxis: {
