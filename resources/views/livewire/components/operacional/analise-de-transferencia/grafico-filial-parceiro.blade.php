<div wire:init="montaChart()">
    ...
    <div wire:loading.class="hidden" class="bg-white p-3 border shadow-md rounded-md">
        <div id="chartFilialParceiro" style="height:280px;"></div>
    </div>

</div>

<script>
    window.addEventListener('renderDataFilialParceiro', ({ detail }) => {
        Highcharts.chart('chartFilialParceiro', {
            chart: {
                type: 'bar'
            },
            title: {
                text: 'Filial x Parceiro'
            },
            xAxis: {
