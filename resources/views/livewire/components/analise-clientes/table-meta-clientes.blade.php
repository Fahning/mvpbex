<div class="bg-white shadow-md pb-4 px-4 rounded-md w-full">
    ...
    <div class="flex items-center mb-1">
        <x-input type="text" id="clientes" name="clientes" wire:model.defer="clientes" label="Buscar Cliente" class="rounded-md"></x-input>
        <div wire:click="seachClientes" class="bg-green-400 rounded-lg h-10 w-10 ml-2 flex justify-center items-center cursor-pointer hover:bg-green-500">
