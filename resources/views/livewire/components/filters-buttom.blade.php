<div class="fixed bottom-4 right-2 z-10">
            ...
            <div class="px-2 pt-2 pb-4 bg-white rounded-md shadow-lg dark-mode:bg-gray-700">
                <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                    <form wire:submit.prevent="filtrar">
                        ...
                        <button @click="open = !open" type="submit" class="border-2 border-transparent bg-blue-500 p-2 w-full font-bold uppercase text-white rounded transition-all hover:border-blue-500 hover:bg-transparent hover:text-blue-500 cursor-pointer">Filtrar</button>
                    </form>
                </div>
            </div>
        </div>
