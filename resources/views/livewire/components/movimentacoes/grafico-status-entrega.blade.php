<div wire:init="montaChart()">
    ...
    <div wire:loading.class="hidden" class="bg-white p-3 border shadow-md rounded-md">
        <div id="chartStatusEntrega" style="height:280px;"></div>
    </div>

</div>

<script>
    window.addEventListener('renderDataStatusEntrega', ({ detail }) => {
        Highcharts.chart('chartStatusEntrega', {
            chart: {
                type: 'bar'
            },
            title: {
            ...
            xAxis: {
                categories: detail.newData.tipo,
                title: {
                    text: null
                },
                min: 0,
