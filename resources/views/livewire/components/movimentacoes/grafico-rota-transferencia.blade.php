<div wire:init="montaChart()">
    ...
    <div wire:loading.class="hidden" class="bg-white p-3 border shadow-md rounded-md">
        <div id="chartRotaTansferencia" style="height:280px;"></div>
    </div>

</div>

<script>
    window.addEventListener('renderDataRotaTansferencia', ({ detail }) => {
        Highcharts.chart('chartRotaTansferencia', {
            chart: {
                type: 'bar'
            },
            title: {
                text: 'Movimentações Por Rota - Transferência'
            },
            xAxis: {
            ...
            series: [{
                name: 'Quantidade',
                data: detail.newData.quantidade
            }],
            tooltip: {
