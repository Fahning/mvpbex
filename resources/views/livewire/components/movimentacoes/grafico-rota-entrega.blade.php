<div wire:init="montaChart()">
    ...
    <div wire:loading.class="hidden" class="bg-white p-3 border shadow-md rounded-md">
        <div id="chartRotaEntrega" style="height:280px;"></div>
    </div>

</div>

<script>
    window.addEventListener('renderDataRotaEntrega', ({ detail }) => {
        Highcharts.chart('chartRotaEntrega', {
            chart: {
                type: 'bar'
            },
            title: {
                text: 'Movimentações Por Rota - Entrega'
            },
            xAxis: {
